...
libbirb.a: database.o dependencies.o utils.o install.o package_info.o cli.o symlink.o download.o uninstall.o package_search.o distclean.o depclean.o sync.o
	gcc-ar -rcs $@ $^
